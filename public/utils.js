  ...
  createHeroInfoTemplate(hero) {
    const heroInfoTemplate = `<div class="hero" id="hero">
          ...
          <div data-slot="Secondary weapon" class="slot">
            ${hero.accessorie ? this.getImage(hero.accessorie.image, "accessories") : ""}
          </div>
...
class ArenaTemplate extends TemplateRoot {
  ...
  createArena(arena) {
    ...
    const arenaTemplate = `${arena.digArena ? `<button class="btn btn-primary btn-shovel" id="digButton"><img src="./images/shovel.svg"><span>Dig</span></button>` : ''}
